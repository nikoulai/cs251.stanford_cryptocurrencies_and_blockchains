...
import AlmaInu from '../artifacts/contracts/token.sol/AlmaInu.json';
import AlmaExchange from '../artifacts/contracts/exchange.sol/AlmaExchange.json';
// sets up web3.js
// const web3 = new Web3(Web3.givenProvider || "ws://localhost:8545");
const web3 = new Web3("ws://localhost:8545");


const exchange_name = 'AlmaSwap'; // TODO: fill in the name of your exchange

const token_name = 'Alma Inu';             // TODO: replace with name of your token
const token_symbol = 'Alma';               // TODO: replace with symbol for your token
...
const token_address = '0x5FbDB2315678afecb367f032d93F642f64180aa3'.toLowerCase();                   
const token_abi = AlmaInu.abi;
const token_contract = new web3.eth.Contract(token_abi, token_address);

// TODO: Paste your exchange address and ABI here
const exchange_address = '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512'.toLowerCase();    
// const exchange_abi = [];            
const exchange_abi =  AlmaExchange.abi;          
...
async function addLiquidity(amountEth, maxSlippagePct) {
    ...
    // console.log("$$$$$$$",amountEth,web3.utils.toWei(amountEth,'ether'));
    return exchange_contract.methods.addLiquidity().send({value: web3.utils.toWei(amountEth,'ether'), from: web3.eth.defaultAccount, gas: 999999});
}

/*** REMOVE LIQUIDITY ***/
async function removeLiquidity(amountEth, maxSlippagePct) {
    /** TODO: ADD YOUR CODE HERE **/
    return exchange_contract.methods.removeLiquidity().send({value: web3.utils.toWei(amountEth), from: web3.eth.defaultAccount, gas: 999999});
...
async function removeAllLiquidity(maxSlippagePct) {
    ...
    return exchange_contract.methods.removeAllLiquidity().send({from: web3.eth.defaultAccount, gas: 999999});
}
...
async function swapTokensForETH(amountToken, maxSlippagePct) {
    ...
    return exchange_contract.methods.swapTokensForETH(amountToken).send({ from: web3.eth.defaultAccount, gas: 999999});
}

async function swapETHForTokens(amountETH, maxSlippagePct) {
    /** TODO: ADD YOUR CODE HERE **/
    return exchange_contract.methods.swapETHForTokens().send({value: web3.utils.toWei(amountETH), from: web3.eth.defaultAccount, gas: 999999});
...
web3.eth.getAccounts().then((response)=> {
    ...
    console.log("inside getAcounts",response);
